...
<body>
            ...
            <section class="wrapper flex flex-col gap-2.5">
                <div class="flex items-center justify-between">
                    ...
                    <button type="button" class="p-2 bg-white rounded-full" data-expand="__detailsPayment">
                        <img src="{{ asset('/assets/svgs/ic-chevron.svg') }}"
                            class="transition-all duration-300 size-5" alt="">
                    </button>
                </div>
                <div class="p-6 bg-white rounded-3xl" id="__detailsPayment" style="display: none;">
                    <ul class="flex flex-col gap-5">
                        ...
                        <li class="flex items-center justify-between">
                            ...
                            <p class="text-base font-semibold first:font-normal " id ="checkout-promo">
            ...
            <section class="wrapper flex flex-col gap-2.5">
                ...
                <div class="p-4 mt-0.5 bg-white rounded-3xl hidden" id="manualPaymentDetail">
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="inline-flex items-center gap-2.5">
                            <img src="{{ asset('assets/svgs/ic-security-card.svg') }}" class="size-5"
                                alt="">
                            <p class="text-base font-semibold">
                                083902093092
                            </p>
                ...
                <form action="{{ route('product_transactions.store') }}" method="POST"
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex flex-col gap-2.5">
                            ...
                            <input style ="background-image: url('assets/svgs/ic-phone.svg')" type="number"
                        ...
                        <div class="flex flex-col gap-2.5">
                            ...
                            <span class="relative">
                                <img src="{{ asset('assets/svgs/ic-edit.svg') }}"
                                    class="absolute size-5 top-4 left-4" alt="">
                                <textarea name="note" id="notes__" class="form-input !rounded-2xl w-full min-h-[150px]">nearby with local shops that close with the big river next to aftermarket place.</textarea>
                            </span>
                        </div>
                        <!-- Proof of Payment -->
                        <div class="flex flex-col gap-2.5">
                            <label for="proof_of_payment" class="text-base font-semibold">Proof of Payment</label>
                            <input style = "background-image: url('/assets/svgs/ic-folder-add.svg')" type="file"
                                name="proof" id="proof_of_payment__" class="form-input ">
                        </div>
                    </div>
        </div>
    ...
    <div
        ...
        <section class="flex items-center justify-between gap-5">
            <div>
                ...
                <p class="text-lg min-[350px]:text-2xl font-bold text-white" id = "price-grandtotal">
    ...
    <script>
        function calculatePrice() {
            ...
            document.getElementById('checkout-promo').textContent = ' Rp ' + deliveryFee.toLocaleString('id', {
            ...
            const ins = 23 * subTotal / 100;

            document.getElementById('checkout-insurance').textContent = ' Rp ' + ins.toLocaleString('id', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            });

            const grandtotal = subTotal + deliveryFee + tax + ins;
            document.getElementById('checkout-grandtotal').textContent = ' Rp ' + grandtotal.toLocaleString('id', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            });


            document.getElementById('price-grandtotal').textContent = ' Rp ' + grandtotal.toLocaleString('id', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            });
        }
